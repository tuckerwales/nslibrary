...
![The Switch app's library grid, showing five games with their installed version under each icon](docs/img/switch-library.jpg)
...
| `NSLIB_COMPRESS_THREADS` | cores − 1, at most 4 | Worker threads zstd uses when compressing NSP to NSZ |
